...
$result = $pdo->query("SELECT p.phone_number, m.mobile_number FROM pinjaman p LEFT JOIN members m ON RIGHT(TRIM(p.phone_number),13) COLLATE utf8mb4_unicode_ci = RIGHT(TRIM(m.mobile_number),13) COLLATE utf8mb4_unicode_ci LIMIT 5");
